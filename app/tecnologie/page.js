          ...
          >
            ...
            >
              ...
              <div className="p-6 space-y-5">
                ...
                <Link href="/contatti" onClick={() => setSelected(null)} className="block w-full text-center py-3.5 bg-primary text-white rounded-full font-semibold text-sm hover:bg-primary/90 transition-all">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 25 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              <Link href="/contatti" className="px-8 py-3.5 bg-primary text-white rounded-full font-semibold text-sm hover:bg-primary/90 transition-all hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/30">
                Prenota Consulenza Gratuita
              </Link>
              <a href="tel:0131234173" className="px-8 py-3.5 border border-primary/40 text-primary rounded-full font-semibold text-sm hover:bg-primary hover:text-white transition-all inline-flex items-center gap-2">
