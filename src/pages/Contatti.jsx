  ...
  return (
    <div className="font-poppins">
      ...
      <section className="relative pt-40 pb-20 text-center overflow-hidden bg-[#16120e]">
        ...
        />
        {/* Decorative rings */}
        <div className="absolute top-24 right-20 w-40 h-40 pointer-events-none hidden lg:block">
      ...
      <section className="relative py-28 bg-[#0f0c0a]">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          ...
          <div className="absolute w-[370px] h-[370px] rounded-full border border-primary/6 float-gentle float-d2" />
        </div>
