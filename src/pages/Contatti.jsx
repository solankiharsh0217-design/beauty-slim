...
export default function Contatti() {
  ...
  return (
    <div className="font-poppins">
      {/* ── Hero ── */}
      <section className="relative pt-40 pb-20 text-center overflow-hidden bg-section-a">
      ...
      {/* ── Contact cards ── */}
      <section className="relative py-16 bg-section-a">
      ...
      {/* ── Form ── */}
      <section className="relative py-28 bg-section-b">
      ...
      {/* ── Call CTA ── */}
      <section className="relative py-24 bg-section-b overflow-hidden">
